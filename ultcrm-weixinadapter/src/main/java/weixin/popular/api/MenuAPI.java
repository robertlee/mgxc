...
import weixin.popular.bean.WeiMenu;
...
public class MenuAPI extends BaseAPI{
	 ...
	 * @return
	 */
	public static WeiMenu menuGet(String access_token){
		HttpUriRequest httpUriRequest = RequestBuilder.post()
					.setUri(BASE_URI+"/cgi-bin/menu/get")
					.addParameter("access_token", access_token)
					.build();
		return LocalHttpClient.executeJsonResult(httpUriRequest,WeiMenu.class);
	}
