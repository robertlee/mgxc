ultcrm.controller('directCtrl', function($scope, $http, $state, $window,
	...
	var markNCStore = function(){
	    ...
	    marker.setLabel({
	        ...
	        content:'<div class="map-label"><h5><b>芒果学车培训中心</b></h5><p>\
	        	<b>地址：</b>芒果学车教育<br><b>\
	...
	//请求用户和门店位置信息
	var url = '/customer/' + customer.id + '/navigateTo/' + 1    /*storeId，目前固定为芒果学车培训中心*/;
