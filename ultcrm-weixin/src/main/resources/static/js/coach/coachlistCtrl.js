ultcrm.controller('coachlistCtrl', function($scope,$http,$location,$state,$stateParams,$timeout,$ionicPopup,customerData,classTypeData) {
	//初始化数据	
	$scope.div0 = false;//显示
	$scope.div1 = true;//隐藏
	$scope.div2 = false;//隐藏
	...
	//3-6   快乐作文  ，
	//7-8   幼小衔接  ，
	$scope.classType =  ["所有的", "C1手动", "C2自动"];
	$scope.title0 = "title1 change0";
